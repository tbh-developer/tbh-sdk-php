...
class Request
{
     ...
     * @param Token           $token
     */
    public function signRequest(SignatureMethod $signatureMethod, Client $Client, Token $token = null)
    {
        $this->setParameter('oauth_signature_method', $signatureMethod->getName());
        $signature = $this->buildSignature($signatureMethod, $Client, $token);
     ...
     * @return string
     */
    public function buildSignature(SignatureMethod $signatureMethod, Client $Client, Token $token = null)
    {
        return $signatureMethod->buildSignature($this, $Client, $token);
    }
